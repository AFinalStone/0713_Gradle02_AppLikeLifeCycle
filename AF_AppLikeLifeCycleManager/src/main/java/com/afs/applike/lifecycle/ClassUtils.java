...
import com.afs.applike.lifecycle.arouter.DefaultPoolExecutor;
...
public class ClassUtils {
    ...
    public static Set<String> getFileNameByPackageName(Context context, final String packageName) throws PackageManager.NameNotFoundException, IOException, InterruptedException {
            ...
            DefaultPoolExecutor.getInstance().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Log.e("AppLike", "Scan map file in dex files made error.", ignore);
                    } finally {
                        if (null != dexfile) {
                            try {
                                dexfile.close();
        ...
        Log.d("AppLike", "Filter " + classNames.size() + " classes by packageName <" + packageName + ">");
        return classNames;
    }
...
//        通过是否存在sp中的multidex.version是不准确的，因为从低版本升级上来的用户，是包含这个sp配置的
    ...
    private static List<String> tryLoadInstantRunDexFile(ApplicationInfo applicationInfo) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && null != applicationInfo.splitSourceDirs) {
            ...
            Log.d("AppLike", "Found InstantRun support");
        } else {
            try {
                ...
                Log.e("AppLike", "InstantRun support error, " + e.getMessage());
            }
        }
    ...
    private static boolean isVMMultidexCapable() {
        ...
        Log.i("AppLike", "VM with name " + vmName + (isMultidexCapable ? " has multidex support" : " does not have multidex support"));
